		...
		if (fileChooser.showSaveDialog(dialog) == JFileChooser.APPROVE_OPTION) {
			...
			try {
				...
				if(tipNaloga.equals("R")){
					...
					JOptionPane.showMessageDialog(dialog, "Greška u o�?itavanju tipa naloga sa tabele: " + tipNaloga, 
				...
				JOptionPane.showMessageDialog(MainFrame.getInstance(), 
						"Dogodila se greška prilikom eksportovanja naloga za međubankarsko plaćanje: \n" +
							e1.getMessage(), 
						"Greška", JOptionPane.ERROR_MESSAGE);
			} catch(Exception e1) {
				e1.printStackTrace();

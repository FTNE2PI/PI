...
public class AnalitikaIzvodaDialog extends GenericDialog {
	...
	protected void initializeFormInputPanel() {
		...
		addComponentToFormInputPanel(panBrojRacuna, "Broj ra�?una", true);
		...
		addComponentToFormInputPanel(tfRacunDuznika, "Ra�?un dužnika", true);
		...
		addComponentToFormInputPanel(tfRacunPoverioca, "Ra�?un poverioca", true);

...
public class RacunPoslovnihLicaDialog extends GenericDialog {
	...
	protected void initializeFormInputPanel() {
		...
		addComponentToFormInputPanel(panSifraValute, "Å ifra valute", true);
		...
		addComponentToFormInputPanel(panSifraBanke, "Å ifra banke", true);
		...
		addComponentToFormInputPanel(cbVazeci, "VaÅ¾eÄ‡i?", false);
